#ifndef AFINA_NETWORK_COROUTINE_ENGINE_H
#define AFINA_NETWORK_COROUTINE_ENGINE_H
...
private:
    ...
    /**
     * List of routines blocked on socket
     */
    context *blocked;
...
public:
    ...
    void blockCoroutine();
    void unblockCoroutine(void* coroutine);
    void unblockAll();

    int getCoroutineEvent();
    void* getCoroutine();
    void setCoroutineEvent(void* coroutine, int event);
...
#endif // AFINA_NETWORK_COROUTINE_ENGINE_H
